...
#Updates the picturesToGoTO as an array, T means that the user wishs to go to that painint, F means they do not
def getList():
...
#Once the user arrives, if its the toilet pass "A" as a param, for exit pass "B" as a param
def toiletAndExitArrived(location):
    httpPost("http://homepages.inf.ed.ac.uk/s1553593/toilet.php", location)
    #Need to reset toilet
    time.sleep(10)
    link = "http://homepages.inf.ed.ac.uk/s1553593/toilet.php"
    httpPost(link, "F")
