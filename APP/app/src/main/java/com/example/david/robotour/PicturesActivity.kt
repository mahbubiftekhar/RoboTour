...
class PicturesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        allArtPieces.add(ArtPiece("Girl with a Pearl Earring", "Johannes Vermeer",
                ...
                "Exhibiendo la mirada electrizante de una niña adornada con un turbante azul y dorado.", R.drawable.girlwithpearlearring, 3))
        ...
        allArtPieces.add(ArtPiece("Napoleon Crossing the Alps",
                ...
                "Óleo sobre lienzo retrato ecuestre de Napoleón Bonaparte pintado por el artista francés Jacques-Louis David entre 1801 y 1805", R.drawable.napoleoncrossingthealps, 5))
        ...
        allArtPieces.add(ArtPiece("The Last Supper", "Leonardo da Vinci",
                ...
                "El tema era tradicional para los refectorios, aunque la sala no era un refectorio en el momento en que Leonardo la pintó.", R.drawable.thelastsupper, 7))
        allArtPieces.add(ArtPiece("The Great Wave of Kanagawa", "Hokusai",
                ...
                "La Grande Vague de Kanagawa, également connue sous le nom de La Grande Vague ou simplement La Vague, est une gravure sur bois de l'artiste japonais Ukiyo-e Hokusai.", R.drawable.tsunami, 8))
        allArtPieces.add(ArtPiece("Water Lilies", "Claude Monet",
                ...
                "El lirio de agua blanca es una planta perenne que a menudo forma colonias densas. Las hojas surgen en tallos flexibles de grandes rizomas gruesos.", R.drawable.waterlillies, 9))
